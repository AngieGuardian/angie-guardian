...
version `0.11.0` for amd64:

```sh
wget https://gitlab.melroy.org/api/v4/projects/210/packages/generic/angie-guardian/0.11.0/angie-guardian-0.11.0-linux-amd64.tar.gz
tar -xzf angie-guardian-0.11.0-linux-amd64.tar.gz
cd angie-guardian-0.11.0-linux-amd64
```
...
```sh
# Same directory as angie-guardian-0.11.0-linux-amd64.tar.gz
wget https://gitlab.melroy.org/api/v4/projects/210/packages/generic/angie-guardian/0.11.0/SHA256SUMS
sha256sum -c --ignore-missing SHA256SUMS
```

```
angie-guardian-0.11.0-linux-amd64.tar.gz: OK
```
